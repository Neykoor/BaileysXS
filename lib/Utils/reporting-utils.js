...
/**
 * Generacion del "reporting token" que WhatsApp adjunta a cada mensaje enviado.
 * Permite que el mensaje sea reportable desde el cliente, tal como lo hace WhatsApp Web.
 *
...
const getMessageReportingToken = async (msgProtobuf, message, key) => {
    ...
    // hkdf en Ryzewa es asincrono (WebCrypto), por eso se espera aqui
